...
from tensorly.tenalg.svd import truncated_svd, symeig_svd, randomized_svd
...
def initialize_cp(tensor, rank, init='svd', svd='truncated_svd', random_state=None, normalize_factors=False):
